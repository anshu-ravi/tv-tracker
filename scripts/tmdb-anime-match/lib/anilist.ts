// Minimal standalone AniList client for the matcher — only the fields needed
// to search TMDB and validate a match (title strings, total episode count,
// series first-air date as a fallback for the absolute-#1 air-date check).
// Not imported from src/lib/anilist.ts — same reasoning as
// scripts/refresh-catalog/lib/anilist.ts.
